...
namespace WpfAppMVVM.Migrations
{
    ...
    [Migration("20240516181719_UpdatingTransportationsTable")]
    partial class UpdatingTransportationsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WpfAppMVVM.Models.Entities.Transportation", b =>
                {
                    ...
                    b.HasOne("WpfAppMVVM.Models.Entities.Route", "Route")
                        ...
                        .HasForeignKey("WpfAppMVVM.Models.Entities.Transportation", "RouteId");
